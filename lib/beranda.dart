...
import 'package:apam/edukasi.dart'; //modul edukasi
import 'package:apam/setting.dart'; //modul edukasi
import 'package:apam/saran.dart'; //modul saran
import 'package:apam/jadwal.dart'; //modul jadwal
import 'package:apam/poli.dart'; //modul poli
import 'package:apam/home.dart';
import 'package:apam/kamar.dart'; //modul kamar
import 'package:shared_preferences/shared_preferences.dart'; //cache aktivitas log
...
class _BerandaPageState extends State<BerandaPage>
  ...
  Future<void> fetchNotifikasi() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/notifikasi.php'));
  ...
  Future<void> fetchImagesFromDatabase() async {
    try {
      final response1 = await http.get(Uri.parse('$baseUrl/carosel.php'));
      final response2 = await http.get(Uri.parse('$baseUrl/carosel2.php'));

      List<String> tempImages = [];

      void addImage(List<dynamic> data) {
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        //menu list kamar ranap
                        _buildMenuCard(
                          Icons.bed,
                          "List Kamar",
                          const Color.fromARGB(255, 146, 99, 62),
